...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath }/order/list.action?userCode=${USER_SESSION.userCode}" class="active">
    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" method="get"
                    ...
                    <input type="hidden" id="userCode" name="userCode" value="${USER_SESSION.userCode}"/>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">已订报刊列表</div>
                    <!-- /.panel-heading -->
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${page.rows}" var="row">
                            <tr>
                                ...
                                <td>${row.orderPortion}</td>
                                <td>${row.orderMonth}</td>
                                <td>
                                    <a href="#" class="btn btn-danger btn-xs"
                                       onclick="deleteOrder('${row.newspaperCode}','${USER_SESSION.userCode}')">退订</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script type="text/javascript">
    ...
    function deleteOrder(newspaperCode,userCode) {
        if (confirm('确实要退订该报刊吗?')) {
            $.post("<%=basePath%>order/delete.action", {"newspaperCode": newspaperCode, "userCode":userCode},
                function (data) {
                    if (data == "OK") {
                        alert("报刊退订成功！");
