...
<div id="particles-js">
    <div class="login" style="display: block;">
        <div class="login-top" style="margin-top: 40px">注册</div>
        ...
        <div class="login-center clearfix">
            ...
            <div class="login-center-input">
                <input type="text" name="userName" id="userName" value="" placeholder="请输入您的姓名"
                       onfocus="this.placeholder=''" onblur="this.placeholder='请输入您的姓名'">
        ...
        <div class="login-button" id="register-button">
            注册
        </div>
        <div class="login-button" id="toLogin-button" style="margin-top: 20px">
            返回
        </div>
    </div>
...
<script type="text/javascript">
    ...
    document.querySelector("#register-button").onclick = function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.type == 'success') {
                        alert(data.msg);
                        window.parent.location = '<%=basePath%>user/login.action';
                    } else {
        ...
        if (usertype == '0') {
            alert("个人无法注册管理员用户，如需注册请联系客服！");
            window.parent.location = '<%=basePath%>user/login.action';
        }
    }

    document.querySelector("#toLogin-button").onclick = function () {
        window.parent.location = '<%=basePath%>user/login.action';
    }
